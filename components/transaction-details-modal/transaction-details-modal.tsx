        ...
        <div>
          <div className="p-4 border border-gray-300 rounded-lg shadow-lg bg-white">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="flex items-center">
                <strong className="mr-2">Giảm giá:</strong>{" "}
                {selectedTransaction.discount}%
              </p>
              <p className="flex items-center">
                <strong className="mr-2">Thời gian bắt đầu:</strong>{" "}
                {dayjs(selectedTransaction.booking_StartDate).format(
                  "DD/MM/YYYY HH:mm"
                )}
              </p>
              <p className="flex items-center">
                <strong className="mr-2">Thời gian kết thúc:</strong>{" "}
            ...
            <div className="space-y-2 text-sm">
              ...
              <p>
                <strong>Địa chỉ:</strong> {selectedTransaction.license_Address}
              </p>
              <p>
                <strong>Tên:</strong> {selectedTransaction.workspace_Name}
              </p>
              <p>
                <strong>Loại:</strong> {selectedTransaction.workspace_Category}
              </p>
              <p>
              ...
              <p>
                <strong>Diện tích:</strong> {selectedTransaction.workspace_Area}{" "}
                m²
              </p>
