function GoogleMap({ url }: { url: string }) {
  ...
  if (coordinates && placeName) {
    embedUrl = `https://www.google.com/maps/embed/v1/place?key=AIzaSyAHYXQ7H8v3vHC2HocjzPUfuLKrwnAaya4&q=${encodeURIComponent(placeName)}&center=${coordinates}&zoom=17`;
  }
  ...
  // If only place name is available
    ...
    embedUrl = `https://www.google.com/maps/embed/v1/place?key=AIzaSyAHYXQ7H8v3vHC2HocjzPUfuLKrwnAaya4&q=${encodeURIComponent(placeName)}`;
  }
  // Default fallback
  else {
