export default function WorkButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      className="group relative overflow-hidden rounded-md bg-primary px-7 py-2 text-sm transition-all border border-white"
      onClick={onClick}
    >
